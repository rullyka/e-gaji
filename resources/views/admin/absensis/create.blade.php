...
@section('title', 'Tambah Absensi Masuk Baru')

@section('content_header')
<h1>Tambah Absensi Masuk Baru</h1>
@stop

@section('content')
<div class="card">
    <div class="card-header">
        <h3 class="card-title">Detail Absensi Masuk</h3>
    ...
    <div class="card-body">
        <form action="{{ route('absensis.store') }}" method="POST">
            ...
            <div class="form-group">
                ...
                <button type="submit" class="btn btn-primary">Simpan Absensi Masuk</button>
            </div>
        </form>
    </div>
</div>
    ...
    $(function() {
        ...
        $('#status').change(function() {
            ...
            if (status === 'Izin' || status === 'Sakit' || status === 'Cuti') {
                ...
                $('#jam_masuk').prop('disabled', false).val('{{ date('
                    H: i ') }}');
