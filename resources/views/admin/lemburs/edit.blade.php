...
<div class="card">
    <div class="card-header">
        <h3 class="card-title">Form Edit Lembur</h3>
    ...
    <div class="card-body">
        ...
        <form action="{{ route('lemburs.update', $lembur) }}" method="POST">
            @csrf
            @method('PUT')
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <select class="form-control select2 @error('karyawan_id') is-invalid @enderror" id="karyawan_id" name="karyawan_id" required>
                            ...
                            <option value="{{ $karyawan->id }}" {{ (old('karyawan_id', $lembur->karyawan_id) == $karyawan->id) ? 'selected' : '' }}>
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control @error('jenis_lembur') is-invalid @enderror" id="jenis_lembur" name="jenis_lembur" required>
                            ...
                            <option value="{{ $jenis }}" {{ (old('jenis_lembur', $lembur->jenis_lembur) == $jenis) ? 'selected' : '' }}>
                                {{ $jenis }}
                            </option>
                            @endforeach
                        </select>
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" class="form-control @error('tanggal_lembur') is-invalid @enderror" id="tanggal_lembur" name="tanggal_lembur" value="{{ old('tanggal_lembur', $lembur->tanggal_lembur->format('Y-m-d')) }}" required>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="time" class="form-control @error('jam_mulai') is-invalid @enderror" id="jam_mulai" name="jam_mulai" value="{{ old('jam_mulai', substr($lembur->jam_mulai, 0, 5)) }}" required>
                        @error('jam_mulai')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="time" class="form-control @error('jam_selesai') is-invalid @enderror" id="jam_selesai" name="jam_selesai" value="{{ old('jam_selesai', substr($lembur->jam_selesai, 0, 5)) }}" required>
                        @error('jam_selesai')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="alert alert-info" id="durasi-lembur">
                            <span id="durasi-text">{{ $lembur->total_lembur }}</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <textarea class="form-control @error('keterangan') is-invalid @enderror" id="keterangan" name="keterangan" rows="3" required>{{ old('keterangan', $lembur->keterangan) }}</textarea>
                        @error('keterangan')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <select class="form-control select2 @error('supervisor_id') is-invalid @enderror" id="supervisor_id" name="supervisor_id" required>
                            ...
                            @foreach($karyawans as $karyawan)
                            <option value="{{ $karyawan->id }}" {{ (old('supervisor_id', $lembur->supervisor_id) == $karyawan->id) ? 'selected' : '' }}>
                                {{ $karyawan->nik_karyawan }} - {{ $karyawan->nama_karyawan }}
                            </option>
                            @endforeach
                        </select>
