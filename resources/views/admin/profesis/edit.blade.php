...
<div class="card">
    ...
    <div class="card-body">
        ...
        <form action="{{ route('profesis.update', $profesi) }}" method="POST">
            @csrf
            @method('PUT')
            <div class="form-group">
                <label for="name_profesi">Nama Profesi <span class="text-danger">*</span></label>
                <input type="text" class="form-control @error('name_profesi') is-invalid @enderror" id="name_profesi" name="name_profesi" value="{{ old('name_profesi', $profesi->name_profesi) }}" required>
                @error('name_profesi')
            ...
            <div class="form-group">
                ...
                <div class="input-group">
                    ...
                    <input type="text" class="form-control rupiah @error('tunjangan_profesi') is-invalid @enderror" id="tunjangan_profesi" name="tunjangan_profesi" value="{{ old('tunjangan_profesi', $profesi->tunjangan_profesi) }}" required>
