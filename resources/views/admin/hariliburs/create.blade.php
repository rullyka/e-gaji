...
<div class="card">
    ...
    <div class="card-body">
        ...
        <form action="{{ route('hariliburs.store') }}" method="POST">
            @csrf
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control @error('nama_libur') is-invalid @enderror" id="nama_libur" name="nama_libur" value="{{ old('nama_libur') }}" required>
                @error('nama_libur')
                <div class="invalid-feedback">
                    {{ $message }}
                </div>
