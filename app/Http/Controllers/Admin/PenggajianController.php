...
class PenggajianController extends Controller
{
    ...
    public function generatePayslip($id)
    {
        ...
        $periode     = $penggajian->periodeGaji;  // Changed from 'periode' to 'periodeGaji'
    ...
    {
        Log::info('Process method called with data:', $request->all());
        ...
        try {
            Penggajian::create([
                ...
                'gaji_pokok'        => $gajiPokok,
                'tunjangan'         => $totalTunjangan,
                'detail_tunjangan'  => json_encode($detailTunjangan),    // Tambahkan json_encode disini
                'potongan'          => $totalPotongan,
                'detail_potongan'   => json_encode($detailPotongan),     // Tambahkan json_encode disini
                'detail_departemen' => json_encode($detailDepartemen),   // Tambahkan json_encode disini
                'gaji_bersih'       => $gajiBersih,
            ]);
